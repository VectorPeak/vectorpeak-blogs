...
<Frame caption="Function calling 原理">
  <img src="https://api.cuiliangblog.cn/v1/public/imgProxy/?url=https://cdn.nlark.com/yuque/0/2025/png/2308212/1754212299090-2a23d847-e779-41b0-81a9-dbc1587cb5c5.png" alt="Function calling 原理" />
</Frame>
...
<Frame caption="Tool 类继承关系">
  <img src="https://api.cuiliangblog.cn/v1/public/imgProxy/?url=https://cdn.nlark.com/yuque/0/2025/png/2308212/1763902365020-ebd967fe-cd88-43f6-8d21-e798c69c6d42.png" alt="Tool 类继承关系" />
</Frame>
...
登录[https://home.openweathermap.org/api\_keys](https://home.openweathermap.org/api_keys)，免费获取API Key，并写入.env文件中，方便后续进行天气查询。
