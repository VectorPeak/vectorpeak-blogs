...
LangChain 链式调用可参考文档：[https://reference.langchain.com/python/langchain\_core/runnables/](https://reference.langchain.com/python/langchain_core/runnables/)
...
<Frame caption="基本结构">
  <img src="https://api.cuiliangblog.cn/v1/public/imgProxy/?url=https://cdn.nlark.com/yuque/0/2025/png/2308212/1752810484524-ccdab3bb-0ade-4e3c-9f30-53f820e7feee.png" alt="基本结构" />
</Frame>
...
* **OutputParser**：将 model 的输出传递给 output\_parser，它是一个 BaseOutpCutParser，意味着它可以接受字符串或 BaseMessage 作为输入。
...
<Frame caption="Runnable 类继承关系">
  <img src="https://api.cuiliangblog.cn/v1/public/imgProxy/?url=https://cdn.nlark.com/yuque/0/2025/png/2308212/1761534001753-fc3fdc99-6e49-4257-b33f-faf6dc352fec.png" alt="Runnable 类继承关系" />
</Frame>
...
<Frame caption="分支链">
  <img src="https://api.cuiliangblog.cn/v1/public/imgProxy/?url=https://cdn.nlark.com/yuque/0/2025/jpeg/2308212/1761701477779-2899ce71-fe6c-4fbc-a4eb-c533fc24ba71.jpeg" alt="分支链" />
</Frame>
...
<Frame caption="例如我们需要多次调用大模型，将多个步骤串联起来实现功能">
  <img src="https://api.cuiliangblog.cn/v1/public/imgProxy/?url=https://cdn.nlark.com/yuque/0/2025/jpeg/2308212/1761702359302-2077b5ee-669a-44e6-ba74-55c26abec6d4.jpeg" alt="例如我们需要多次调用大模型，将多个步骤串联起来实现功能" />
</Frame>
...
<Frame caption="并行链">
  <img src="https://api.cuiliangblog.cn/v1/public/imgProxy/?url=https://cdn.nlark.com/yuque/0/2025/jpeg/2308212/1761702359600-fe66a419-b187-432a-b625-1bb65485a8f3.jpeg" alt="并行链" />
</Frame>
...
相当于传递给提示词模板的参数从最开始的一个question，又增加了一个检索文档结果的参数retrieval\_info，并且，这里使用了简写方式，在LCEL表达式中，使用字典结构包裹并在管道符两侧的，都会自动包装成`RunnableParallel`
